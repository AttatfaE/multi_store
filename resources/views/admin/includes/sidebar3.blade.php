                    ...
                    <li><a class="menu-item" href="#" data-i18n="nav.other_pages.coming_soon.main">{{__('admin/sidebar.Shipping')}}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.setting.shipping.edit','free')}}"
                                   data-i18n="">{{__('admin/sidebar.Free shipping')}}</a>
                            </li>
                            <li><a class="menu-item" href="">{{__('admin/sidebar.National Shipping')}}</a>
                                <ul class="menu-content">

                                    <li><a class="menu-item" href="{{route('admin.setting.shipping.edit','quebec')}}"
                                           data-i18n="">{{__('admin/sidebar.Quebec shipping')}}</a>
                                    </li>
                                    <li><a class="menu-item" href="{{route('admin.setting.shipping.edit','canada')}}"
                                           data-i18n="">{{__('admin/sidebar.Canada shipping')}}</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.setting.shipping.edit','international')}}"
                                   data-i18n="">{{__('admin/sidebar.International shipping')}}</a>
                            </li>
